...
|                 |           | \<dbl\>   |           |           |
+:================+==========:+==========:+==========:+==========:+
| ( Intercept)    | -2 3 2    | 1 57      | 1         | 0.1729390 |
|                 | 8.5151515 | 3.052665  | .48025251 |           |
+-----------------+-----------+-----------+-----------+-----------+
| YEAR            | 1.1515152 | 0.777581  | 1         | 0.1727716 |
|                 |           |           | .48089418 |           |
+-----------------+-----------+-----------+-----------+-----------+
| BABESIOSIS      | 0.4242424 | 5.484565  | 0         | 0.9400358 |
|                 |           |           | .07735207 |           |
+-----------------+-----------+-----------+-----------+-----------+
...
| CHAFFEENSIS     |           |           | .96938889 |           |
+-----------------+-----------+-----------+-----------+-----------+
| EHRLICHIA       | -         | 6.364775  | 0         | 0.8604390 |
| EWINGII         | 1.1515152 |           | .18092002 |           |
+-----------------+-----------+-----------+-----------+-----------+
| LYME DISEASE    | 8.5606061 | 4.963745  | 1         | 0.1186814 |
|                 |           |           | .72462659 |           |
+-----------------+-----------+-----------+-----------+-----------+
| ROCKY MOUNTAIN  | 0.5757576 | 5.484565  | 0         | 0.9186958 |
| SPOTTED FEVER   |           |           | .10497781 |           |
+-----------------+-----------+-----------+-----------+-----------+
| WEST NILE (WNV) | 8.2272727 | 5.593721  | 1         | 0.1754208 |
| INFECTION       |           |           | .47080497 |           |
+-----------------+-----------+-----------+-----------+-----------+
...
|          |          | \<dbl\>  | \<dbl\>  |          |
+:=========+=========:+=========:+=========:+=========:+
| ( I      | 9 9      | 5 7      | 1.733920 | 0        |
| n        | 3        | 2        |          | .1434648 |
| tercept) | 5.267857 | 9.946482 |          |          |
+----------+----------+----------+----------+----------+
| YEAR     | -        | 2.835202 | -        | 0        |
|          | 4.910714 |          | 1.732051 | .1438108 |
+----------+----------+----------+----------+----------+
...
|                | Used           |                |                |
+================+================+================+================+
| Random Forest  | Age, Sex,      | 78.1%          | 0.68           |
|                | County,        |                |                |
|                | Disease        |                |                |
+----------------+----------------+----------------+----------------+
